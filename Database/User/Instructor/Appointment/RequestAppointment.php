...
$query = "UPDATE lessonAppointments SET student_id='$student_id', available='Pending' WHERE start = '$start' AND end = '$end' AND available = 'Yes' AND instructor_id = '$instructor_id' AND date= '$date'";
